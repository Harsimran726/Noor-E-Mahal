            ...
            <div class="services-grid">
                ...
                <div class="service-card reveal delay-<?= (++$i % 3) + 1 ?>">
                    <img src="<?= $images['home_facility_' . $i] ?? 'static/Noor_e_mahal_ png (6).png' ?>"
                        class="service-card-bg" alt="<?= htmlspecialchars($fac['name'] ?? '') ?>" loading="lazy">
                    <div class="service-card-overlay"></div>
                    <div class="service-card-content">
                        <div class="service-icon"><i
                                class="<?= htmlspecialchars($fac['icon_class'] ?? '') ?> fa-2x"></i></div>
            ...
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <div class="footer-social">
                        <a href="<?= $content['common_footer_instagram'] ?? 'https://www.instagram.com/nooremahal_mansa/' ?>" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                            <svg viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="<?= $content['common_footer_facebook'] ?? 'https://www.facebook.com/people/Noor-E-Mahal/61586134415662/' ?>" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                            <svg viewBox="0 0 24 24">
                                <path
